Here is a link to the igloo plugin google drive: https://drive.google.com/drive/folders/1Nv2sl48A1vhDQbuHftP5-biG8-TUf9MM

The Igloo plugin needs to be installed while inside a project. To open a project that has the plugin, you need to have it installed previously. This is an issue if you're a secondary team member pulling the group project from the gitHub.
